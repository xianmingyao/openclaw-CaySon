...
add_content_slide(prs, "目录", [
    "一、技术团队介绍 — 农场认养小鸡商城项目经验",
    "二、系统架构 — 分销角色体系、商品规则、关系绑定",
    "三、奖励体系 — 直推奖、对碰奖、代数奖、滑落奖、职级分红",
    "四、API对接 — 对接系统、数据交互方式",
    "五、核心卖点总结"
])
...
# ===== SLIDE 8: Direct Push Award =====
add_two_column_slide(prs, "奖励体系 — 直推奖",
    "首年利润", ["裂变1个BU，获得首年利润5%"],
    "次年收益", ["首年后持续获得2%收益"]
)

# ===== SLIDE 9: Matching Award =====
...
# ===== SLIDE 10: Generation Award Table =====
