...
if ($proc -and $proc.MainWindowHandle -ne 0) {{
    ...
    Write-Output "SUCCESS: Activated QQMusic"
}} else {{
    Write-Output "FAILED: QQMusic not found or no window"
}}
'''
...
def search_and_play_desktop():
    """使用桌面端进行搜索和播放"""
    print("=== Using Desktop App (QQMusic) v6 ===")
...
def main():
    print("=== Smart Music Automation v6 ===")
