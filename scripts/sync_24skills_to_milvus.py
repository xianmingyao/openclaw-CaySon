...
# Read the doc
content = open(r'E:\workspace\knowledge-base\wiki\来源\OpenClaw-24个视频剪辑Skills.md', 'r', encoding='utf-8').read()
...
print(f'[3] 开始同步记忆到云端 ({len(memories)}个块)...')
success = 0
