...
content = Path(r'E:\workspace\knowledge-base\wiki\来源\obsidian-ai-best-knowledge-tool.md').read_text(encoding='utf-8')
blocks = notion_blocks_from_markdown(content)

result = create_notion_page('Obsidian-AI时代最佳知识管理工具', blocks, db_id)
