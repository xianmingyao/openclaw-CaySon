# -*- coding: utf-8 -*-
"""Generate P0 fixes summary document"""

OUT = r'E:\workspace\GEO-Platform-p0-fixes.md'

content = '''# GEO-Platform P0 修复实施报告
...
with open(OUT, 'w', encoding='utf-8') as f:
    f.write(content)
import os
print(f'P0 fixes doc: {os.path.getsize(OUT)} bytes')
