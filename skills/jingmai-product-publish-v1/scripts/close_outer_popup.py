...
# 外层弹窗的X按钮坐标 [974, 137] -> 实际 (2494, 191)
x_btn = (2494, 191)

print(f"\nClicking OUTER popup X at {x_btn}")
click(x_btn[0], x_btn[1], 3)
save_screenshot('outer_x')

time.sleep(2)
img = ImageGrab.grab(bbox=rect)
img.save(r'E:\workspace\skills\jingmai-product-publish\logs\after_outer_close.png')
