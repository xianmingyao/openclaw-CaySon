...
class AgentExecutor:
    ...
    def _run_t5_weight_probe(
        ...
        for variant in ordered_variants:
            sub_params = dict(params, sku_cell_id=self.SKU_DIMENSION_MAPPING["weight"], sku_value=variant, sku_submit=submit)
    ...
    def _resolve_detail_content(self, params: dict[str, Any]) -> str:
        ...
        raise StepValidationError("T6 detail editor requires detail_content, detail_html, detail_content_file or jd_item_url")
