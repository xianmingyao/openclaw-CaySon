...
def test_workflow_t6_upload_transparent_image_is_idempotent_when_slot_filled(tmp_path):
    class AlreadyFilledTransparentAdapter(DummyT6T8Adapter):
        ...
        def inspect_image_upload_slots(self, handle: str) -> list[dict[str, object]]:
            return [
                {"status": "filled", "class_name": "Image", "text": "", "bounds": {"left": 1027, "top": 716, "right": 1092, "bottom": 781}},
                {"status": "empty", "class_name": "DataItem", "text": "请上传图片", "bounds": {"left": 1187, "top": 716, "right": 1252, "bottom": 785}},
                {"status": "filled", "class_name": "Image", "text": "", "bounds": {"left": 1810, "top": 716, "right": 1875, "bottom": 781}},
            ]
