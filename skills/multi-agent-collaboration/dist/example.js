...
// ========== 1. 初始化系统 ==========
console.log('【1. 初始化系统】');
const ai = new index_1.AICollaborationSystem('my_ai_system', '../memory');
console.log('✅ 系统初始化完成\n');
// ========== 2. 信息信号识别 ==========
...
console.log('核心信号:');
scanReport.signals.filter((s) => s.level === 'core' || s.level === 'meta').forEach((s) => {
...
console.log('隐性知识:');
workflowReport.tacitKnowledge.forEach((k) => {
