...
OpenClaw Ledger uses semantic understanding to identify financial transactions from natural conversation text.
...
| **Bonus** | "奖金1000", "got a bonus" | amount: +1000, type: income |
...
| **Reimbursed** | "他转了我200", "he paid me back" | amount: +200, type: income |
...
- Other people's spending: "My friend spent $500"
...
3. **User Config**: `default_currency` in settings (default: CNY)
4. **Locale Inference**: Based on user timezone
...
Based on keywords in conversation:

| Keywords | Category |
|---------|----------|
| 吃、饭、餐厅、火锅、午餐、晚餐、食堂、外卖、咖啡、茶 | food |
| 打车、地铁、公交、开车、加油、停车、机票、高铁 | transport |
| 淘宝、京东、拼多多、购物、买衣服、超市、便利店 | shopping |
| 电影、KTV、游戏、演出、门票、旅游 | entertainment |
| 话费、网费、电费、水费、燃气费 | utilities |
| 房租、物业、装修 | housing |
| 医院、药店、体检、健身 | health |
| 课程、书、培训、学校 | education |
| 理发、美容、化妆品、护肤品 | personal |
| 会员、订阅、Netflix、Spotify、爱奇艺 | subscription |

## False Positive Prevention

### Ignore These Contexts

- **Prices Without Purchase**: "The new iPhone costs $999" (just info)
...
## Multi-Person Expenses

When multiple people are mentioned:

```yaml
# Example: "我和同事A、同时B一起吃饭，花了240"
expense:
  amount: 240.00
  people: ["我", "同事A", "同事B"]
  split_type: equal  # equal | custom
  my_share: 80.00   # 240 / 3 = 80
```

Split types:
- **equal**: Amount divided by number of people
- **custom**: User specifies their share
