...
if chrome_windows:
    ...
    # First, click on the note to open it
    note_x = left + 350
    note_y = top + 300
    print(f"Opening note at ({note_x}, {note_y})...")
    dc.click(note_x, note_y)
    time.sleep(1)
    
    # Now click on the editor area (center-right of the window)
    editor_x = left + 600
    editor_y = top + 400
...
- [ ] 测试 Milvus 双写同步"""
    ...
    time.sleep(2)
    dc.screenshot(filename="md_note_written.png")
