...
if chrome_windows:
    ...
    # Click in the editor area (center-right of the window)
    editor_x = left + 600
    editor_y = top + 400
...
#### 1. claude-code-action (第5个工具)
- Star数：6.5k
- Watch: 40 | Fork: 1.6k
- 功能：GitHub Action，将Claude Code集成到CI/CD工作流中
- 特点：140个发布版本，500+部署
- 源码结构：
  - .claude: gh.sh包装器
  - .github: 非写权限用户检查工作流
...
- 测试 Milvus 双写同步功能"""
    ...
    time.sleep(2)
    dc.screenshot(filename="note_written.png")
